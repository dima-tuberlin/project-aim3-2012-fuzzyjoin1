 ...
 */
public class PactRecordAndDouble extends PactPair<PactRecord, PactDouble> {

    public PactRecordAndDouble() { super(); }
    
    public PactRecordAndDouble(PactRecord record, PactDouble sim) {
        super( record, sim );
    }
    
    public PactRecord getRecordKey() {
